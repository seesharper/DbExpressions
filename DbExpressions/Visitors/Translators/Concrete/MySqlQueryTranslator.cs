...
{
    /// <summary>
    /// Translates a <see cref="DbExpression"/> into a MySql specific string representation.
    /// </summary> 
    /// <remarks>
    /// DayOfWeek
    /// MilliSeconds
    /// </remarks>   
    public class MySqlQueryTranslator : DbQueryTranslator
    {
        /// <summary>
        ...
        public MySqlQueryTranslator(DbProviderFactory providerFactory) : base(providerFactory)
        {
        }
