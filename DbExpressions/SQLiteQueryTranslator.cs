...
{
    /// <summary>
    /// Translates a <see cref="DbExpression"/> into a SqlLite specific string representation.
    /// </summary>
    public class SQLiteQueryTranslator : DbQueryTranslator
    {
        /// <summary>
        ...
        public SQLiteQueryTranslator(DbProviderFactory providerFactory) : base(providerFactory)
        {
        }
        ...
        protected virtual string GetMathematicalFunctionBody(DbMathematicalFunctionExpressionType mathematicalFunctionExpressionType)
        {
            switch (mathematicalFunctionExpressionType)
            {
                ...
                case DbMathematicalFunctionExpressionType.RandSeed:
                    throw new NotSupportedException("Random seed values are not supported by SQLite");
